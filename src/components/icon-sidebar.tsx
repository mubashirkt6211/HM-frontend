    ...
    return (
        <div className="w-[60px] h-screen bg-[#F8F9FA] dark:bg-[#09090b] border-r border-zinc-200/50 dark:border-zinc-800/50 flex flex-col items-center py-4 shrink-0 transition-all z-10">
            ...
            <div className="flex flex-col gap-3 w-full items-center mt-2">
                <NavItem icon={LayoutGrid} bgColor="bg-amber-400" iconColor="text-white" isActive />
                ...
                <NavItem icon={Heart} bgColor="bg-rose-100" iconColor="text-rose-500" />
                <NavItem icon={CreditCard} bgColor="bg-blue-100" iconColor="text-blue-500" />
                <NavItem icon={Clock} bgColor="bg-emerald-50" iconColor="text-emerald-500" />
                <NavItem icon={Smile} bgColor="bg-amber-50" iconColor="text-amber-500" />
            </div>
